...
public record AuctionCreatedStreamEvent(String streamId, Integer auctionId, Integer sellerId, Integer itemId, String auctionName,
    ...
    static AuctionCreatedStreamEvent from(String streamId, Map<String, String> v) {
        try {
            ...
            return new AuctionCreatedStreamEvent(streamId, Integer.valueOf(required(v,"auctionId")), Integer.valueOf(required(v,"sellerId")), Integer.valueOf(required(v,"itemId")),
