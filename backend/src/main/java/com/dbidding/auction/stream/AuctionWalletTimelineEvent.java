...
public sealed interface AuctionWalletTimelineEvent permits BidAcceptedStreamEvent, WalletStateChangedStreamEvent, AuctionCreatedStreamEvent, AuctionCloseRequestedStreamEvent, OrderStateChangedStreamEvent {
    String streamId();
