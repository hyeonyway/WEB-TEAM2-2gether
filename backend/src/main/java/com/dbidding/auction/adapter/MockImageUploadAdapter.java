...
@Component
@Primary
@Profile("auction-mock | local-upload")
public class MockImageUploadAdapter implements ImageUploadPort {
    @Override
    ...
    private ResolvedImage resolve(String uploadToken, int sortOrder) {
        ...
        return new ResolvedImage("/mock/uploads/" + uploadToken, sortOrder, sortOrder == 0);
    }
}
