...
| 2 | #113 | **다음** | [인증 세션과 API Client](2-auth-session-and-api-client.md) | 앱 시작 Refresh, Bearer와 단일 401 갱신 |
| 3 | #114 | 대기 | [Wallet 잔액](3-wallet-balance.md) | Header·마이페이지의 실제 총액·동결액·가용액 |
| 4 | #115 | 대기 | [Wallet 충전·환불](4-wallet-charge-and-refund.md) | 멱등 모의 거래와 서버 잔액 동기화 |
| 5 | #116 | 대기 | [Auction Wallet 접점](5-auction-wallet-integration.md) | 입찰 화면에 Wallet·Auth 계약 전달 |
