...
사용자는 전자지갑을 통해 경매 입찰과 카드 구매에 필요한 잔액을 관리할 수 있습니다.

- 전자지갑 충전
- 충전 금액 환불
- 보유 잔액 확인

![전자지갑 충전 GIF](./asset/gif/wallet-topup.gif)
...
![카드 시세 조회 화면 GIF](./asset/gif/card-market-price.gif)
...
사용자는 나의 대시보드에서 낙찰 내역과 주문 상태를 확인하고,
낙찰된 상품의 주문을 체결할 수 있습니다.
...
![나의 대시보드 GIF](./asset/gif/my-dashboard.gif)
...
<img src="asset/dbidding_architecture.png" alt="dbidding 시스템아키텍처">
